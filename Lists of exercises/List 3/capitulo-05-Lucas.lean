...
(B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F) :=
    or.elim h6
        (assume h7 : E,
        show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
        (B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F), from or.inr (or.inr (or.inl (and.intro h5 h7))))
        (assume h7 : F,
        show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
        (B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F), from or.inr (or.inr (or.inr (or.inr (or.inl (and.intro h3 h7))))))
...
(B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F) :=
    ...
    (assume h5 : D,
    show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
    (B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F), from or.inr (or.inr (or.inr (or.inl (and.intro h3 h5)))))
...
(B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F) :=
    or.elim h6
        (assume h7 : E,
        show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
        (B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F), from  or.inr (or.inl (and.intro h3 h7)))
        (assume h7 : F,
        show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
        (B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F), from or.inr (or.inr (or.inr (or.inr (or.inr (and.intro h5 h7))))))
...
(B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F) :=
    ...
    have h6 : E ∨ F, from and.right (and.right h1),
    show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
    (B ∧ D) ∨ (B ∧ F) ∨ (D ∧ F), from or.inl (and.intro h3 h5))
    (assume h5 : D,
    have h6 : E ∨ F, from and.right (and.right h1),
    show (A ∧ C) ∨ (A ∧ E) ∨ (C ∧ E) ∨
